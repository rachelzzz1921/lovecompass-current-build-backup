...
| 文件 | 作用 |
|---|---|
| `docs/套二_ROS关系测评体系_V2.0.md` | 产品原则、流程、五维、双人匹配、报告结构的可读说明 |
| `data/ros_suite_spec_v2.json` | 同上内容的结构化 JSON，供脚本 / AI / 后台引用 |
| `data/suite2_ros_female.json`、`data/suite2_ros_male.json` | 男女版 60 题题库与评分规则源数据 |

**套三体系规范文档（V1.0）**

| 文件 | 作用 |
|---|---|
| `docs/套三_MATE择偶坐标体系_V1.0.md` | 产品定位、FS/MS 五维、四象限、六种定位、红娘框架、套一联动 |
| `data/mate_suite_spec_v1.json` | 同上内容的结构化 JSON，含计分公式与定位触发条件 |
| `data/suite3_mate_female.json`、`data/suite3_mate_male.json` | 男女版 80 题题库与评分规则源数据 |

**三套共用分析话术词库**

| 文件 | 作用 |
|---|---|
| `data/analysis_phrase_library_v1.json` | 五档分数描述、洞察槽位、敏感字段转化、套间联动模板 |
| `docs/三套题分析话术与词库复用指南.md` | 词库使用说明，结果页 / AI Prompt 注入顺序 |
