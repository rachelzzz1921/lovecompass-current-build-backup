...
INSERT INTO public.test_questions (suite_id, external_question_id, display_order, dimension_code, question_type, weight, direction, question_text, question_payload, scoring_payload, is_active)
SELECT s.id, 'FS1-F-01', 1, 'FS1', 'slider', 2.0, 'positive', '先来校准一下你的外形基础：', '{"note":"这个观察只帮助系统理解你的起点，不会以数字形式出现在结果里。","slider":{"min":1,"max":10,"step":1,"displayMode":"appearance","reference":[{"score":5,"desc":"普通大众，走在街上不会被特别注意"},{"score":6,"desc":"有辨识度，朋友会说「你挺好看的」"},{"score":7,"desc":"明显好看，陌生场合经常有人注意你"},{"score":8,"desc":"同龄人里前10%，有人为你外形回头"},{"score":9,"desc":"同龄人里前3%，经常被建议拍照拍视频"},{"score":10,"desc":"极少数"}]},"source_question":{"id":"FS1-F-01","order":1,"module":"FS1","sub":"FS1_A","type":"slider","weight":2.0,"direction":"positive","text":"先来校准一下你的外形基础：","note":"这个观察只帮助系统理解你的起点，不会以数字形式出现在结果里。","slider":{"min":1,"max":10,"step":1,"displayMode":"appearance","reference":[{"score":5,"desc":"普通大众，走在街上不会被特别注意"},{"score":6,"desc":"有辨识度，朋友会说「你挺好看的」"},{"score":7,"desc":"明显好看，陌生场合经常有人注意你"},{"score":8,"desc":"同龄人里前10%，有人为你外形回头"},{"score":9,"desc":"同龄人里前3%，经常被建议拍照拍视频"},{"score":10,"desc":"极少数"}]},"scoring":{"method":"direct_times_10"}}}'::jsonb, '{"method":"direct_times_10"}'::jsonb, true
...
INSERT INTO public.test_questions (suite_id, external_question_id, display_order, dimension_code, question_type, weight, direction, question_text, question_payload, scoring_payload, is_active)
SELECT s.id, 'MS4-M-15', 15, 'MS4', 'slider', 1.5, 'positive', '你觉得自己的整体外形，在同龄男性里处于什么水平？', '{"slider":{"min":0,"max":100,"min_label":"比较普通，外形不是我的优势","max_label":"外形明显好于同龄人"},"source_question":{"id":"MS4-M-15","order":15,"type":"slider","weight":1.5,"direction":"positive","text":"你觉得自己的整体外形，在同龄男性里处于什么水平？","slider":{"min":0,"max":100,"min_label":"比较普通，外形不是我的优势","max_label":"外形明显好于同龄人"},"scoring":{"method":"slider_to_5","formula":"value / 100 * 5"},"module":"MS4","sub":"MS4_A"}}'::jsonb, '{"method":"slider_to_5","formula":"value / 100 * 5"}'::jsonb, true
FROM public.test_suites s WHERE s.slug = 's03_mate_male_lite'
ON CONFLICT (suite_id, external_question_id) DO UPDATE SET
  display_order = EXCLUDED.display_order,
  dimension_code = EXCLUDED.dimension_code,
