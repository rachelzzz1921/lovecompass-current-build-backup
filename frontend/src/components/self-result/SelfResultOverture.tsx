...
export function SelfResultOverture({ result, onScrollToActOne }: Props) {
  ...
  return (
    <section id="overture" className="text-center min-h-[70vh] flex flex-col items-center justify-center pb-8">
      <motion.span
      ...
      >
        <ScoreOrb value={result.overallScore} size={180} breakdown={breakdown} />
      </motion.div>
